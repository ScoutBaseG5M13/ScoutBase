...
public class RemoveTrainerUseCase {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RemoveTrainerUseCase.class);
    private final UserTeamRepository userTeamRepository;

    /**
     * Removes a trainer from a User Team.
     *
    ...
    public boolean execute(UUID teamId, UUID userId) {
        ...
        userTeam.setTrainer(null);
        userTeamRepository.save(userTeam);
        logger.info("[DELETE] Removed trainer from Team '{}'", teamId);
        return true;
    }
}
