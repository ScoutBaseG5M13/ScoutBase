...
class RemoveTrainerUseCaseTest {

    @Mock
    private UserTeamRepository userTeamRepository;

    @InjectMocks
    private RemoveTrainerUseCase removeTrainerUseCase;

    @Test
    void execute_ShouldRemoveTrainer_WhenDataIsValid() {
        ...
        boolean result = removeTrainerUseCase.execute(teamId, userId);

        assertTrue(result);
        assertNull(userTeam.getTrainer());
    ...
    void execute_ShouldThrowException_WhenTeamIdIsNull() {
        ...
        UserTeamException exception = assertThrows(UserTeamException.class, () ->
                removeTrainerUseCase.execute(null, userId)
        );
    ...
    void execute_ShouldThrowException_WhenUserIdIsNull() {
        ...
        UserTeamException exception = assertThrows(UserTeamException.class, () ->
                removeTrainerUseCase.execute(teamId, null)
        );
    ...
    void execute_ShouldThrowException_WhenTeamNotFound() {
        ...
        UserTeamException exception = assertThrows(UserTeamException.class, () ->
                removeTrainerUseCase.execute(teamId, userId)
        );
